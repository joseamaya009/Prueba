...
export function HomeManagement() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="min-w-0">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mt-2">
            <Badge className="bg-green-600">
              {currentUserAdminHomes.length} como Administrador
            </Badge>
            <Badge variant="secondary">
              {currentUserMemberHomes.length} como Miembro
            </Badge>
          </div>
        </div>
                  ...
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {userRole === 'admin' ? (
                          <Badge className="bg-green-600">Administrador</Badge>
                        ) : userRole === 'member' ? (
                    ...
                    <DialogContent className="max-w-2xl">
                      <form onSubmit={(e) => handleEditHome(e, home.id)}>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Actualiza los datos principales de {home.name}.
                          </DialogDescription>
                        </DialogHeader>
              ...
              {!isAdmin && userRole === 'member' && (
                <Alert className="mt-4">
                  ...
                  <AlertDescription className="text-xs">
                    Eres miembro de este hogar. Solo el administrador puede realizar cambios.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
                  ...
                  <div className="space-y-4 py-2">
                    ...
                    <div className="rounded-lg border p-3">
                      <div className="mb-3 flex items-center justify-between gap-3">
                        <div>
                          <p className="text-sm font-medium">Miembros vinculados</p>
                          <p className="text-xs text-gray-600">Usuarios con acceso a este hogar</p>
                        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Gestión de Usuarios y Hogares</CardTitle>
          <CardDescription>Administra usuarios y sus membresías en diferentes hogares</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="by-home" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mobile-equal-tabs [--mobile-tabs:2]">
              <TabsTrigger value="by-home">Por Hogar</TabsTrigger>
            ...
            <TabsContent value="by-home" className="space-y-4">
              ...
              {!isCurrentUserAdmin(selectedHomeForMembers) && (
                <Alert>
                  <AlertCircle className="size-4" />
                  <AlertDescription className="text-xs">
                    Solo puedes ver los miembros. Para agregar o eliminar miembros debes ser administrador de este hogar.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              Miembro de {getUserHomes(user.id).length} hogar(es)
                            </div>
                          </div>
                        </div>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ¿Estás seguro de remover a {user.name} de este hogar? El usuario seguirá existiendo en otros hogares.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                  <AlertDialogCancel>{t('homes.cancel')}</AlertDialogCancel>
                ...
                {homeMembers.filter(m => m.homeId === selectedHomeForMembers).length === 0 && (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">No hay miembros en este hogar</p>
                  </div>
                )}
                  ...
                  <DialogContent className="max-w-2xl">
                    <form onSubmit={handleAddMember}>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Crea un nuevo usuario o agrega uno existente al hogar (si el email ya existe, se agregará al hogar)
                        </DialogDescription>
                      </DialogHeader>
                ...
                {users.map((user) => {
                  ...
                  return (
                    <div key={user.id} className="border rounded-lg p-4">
                      ...
                      {userHomes.length > 0 ? (
                        <div className="space-y-2">
                          <div className="text-xs text-gray-600 mb-2">Miembro de {userHomes.length} hogar(es):</div>
                          <div className="flex flex-wrap gap-2">
                            {userHomes.map((membership) => (
                              <Badge key={membership.id} variant="secondary" className="flex items-center gap-2">
                                <Building2 className="size-3" />
                                {membership.homeName}
                                {membership.role === 'admin' && <span className="text-xs">(Admin)</span>}
                              </Badge>
                            ))}
                          </div>
                        </div>
      ...
      <Dialog open={isAddToHomeDialogOpen} onOpenChange={setIsAddToHomeDialogOpen}>
        <DialogContent className="max-w-2xl">
          <form onSubmit={handleAddUserToHome}>
            <DialogHeader>
              <DialogTitle>Agregar Usuario a Hogares</DialogTitle>
              <DialogDescription>
                Selecciona los hogares a los que deseas agregar este usuario
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label>Seleccionar hogares (solo tus hogares como admin) *</Label>
                <div className="space-y-2 max-h-64 overflow-y-auto border rounded-lg p-3">
                      ...
                      <label key={home.id} className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded cursor-pointer">
                        ...
                        <div className="flex-1">
                          <div className="text-sm flex items-center gap-2">
                            ...
                            {home.name}
                            {isMember && <Badge variant="outline" className="text-xs">Ya es miembro</Badge>}
                          </div>
                  ...
                  {homes.filter(home => isCurrentUserAdmin(home.id)).length === 0 && (
                    <div className="text-center py-4 text-gray-500 text-sm">
                      No tienes hogares donde seas administrador
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="userHomeRole">Rol en los hogares *</Label>
                <Select name="memberRole" required defaultValue="member">
